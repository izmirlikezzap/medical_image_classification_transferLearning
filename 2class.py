...
def run_training():
    ...
    print(f"   Image Versions: {IMAGE_VERSIONS}") # Yeni versiyonları yazdır
    print(f"   Devices: {device_ids}")

    # Tek bir veri seti kombinasyonu tanımlamak yerine,
    # tüm versiyonlar için döngü oluştur
